...
class FireworkAnimation:
    def __init__(self, screen, background_image_path, sound_file_path, screen_width=1125, screen_height=701):
        self.screen = screen
        ...
        # Ustawienie przycisku dźwięku w lewym dolnym rogu
        self.sound_button_rect = self.sound_image.get_rect(bottomleft=(0, self.screen_height))
    ...
    def draw_fireworks(self):
        ...
        text_rect = text.get_rect(center=(self.screen_width // 2-20, self.screen_height // 2))
...
background_image_path = "rooms/r_table.png"
