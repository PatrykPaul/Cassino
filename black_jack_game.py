...
script_path = "class_fireworks_bj.py"
pygame.init()
...
pygame.mixer.init()
card_sound = pygame.mixer.Sound('audio_files/putting_cards.mp3')
...
background_image = 'rooms/table.PNG'
...
button = BlackjackQuestionButton('buttons/question.png', (900, 500), (100, 50), FONT)
money_belt_display = MoneyBeltDisplay(FONT, "money.txt", 'rooms/belt.png', 0.15)
exit_button = Exit_Button(screen, "buttons/exit.png", (SCREEN_WIDTH, 0))  # Create Exit_Button instance
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_h and player_turn and not game_over:
                if current_money - final_bet >= 0:
                    player_hand.append(shuffled_deck.pop())
                    card_sound.play()
                    if hand_value(player_hand) > 21:
                        game_over = True
                        player_turn = False
                        money_belt_display.handle_loss(final_bet)
                ...
                if current_money - final_bet >= 0:
                    ...
                    if player_score > 21:
                        ...
                        money_belt_display.handle_win(final_bet, 2)
