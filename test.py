...
class BetButton:
    def __init__(self, path, scale, bet):
        self.image = load_scaled_image(path, scale)
...
def main():
    ...
    bet_buttons = {
        '100': BetButton('buttons/100.png', 0.08, 100),
        '1000': BetButton('buttons/1000.png', 0.08, 1000),
        '10000': BetButton('buttons/10000.png', 0.08, 10000),
        'ALL-IN': BetButton('buttons/ALL-IN.png', 0.08, 'all-in'),
        'CLEAR': BetButton('buttons/clear.png', 0.08, 'clear')
    }

    x_start = 170
    for button in bet_buttons.values():
        button.rect.topleft = (x_start, 701 - 80)
